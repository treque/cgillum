#ifndef __INF2705_MATRICE_H__
#define __INF2705_MATRICE_H__

///////////////////////////////////////////////////////////////////////////
/// @class MatricePipeline
/// @brief Cette classe pour les matrices du pipeline graphique
///
///        Les matrices de modélisation, de visualisation, de projection et
///        possiblement de texture sont utilisées pour le pipeline graphique.
///
...
public:
    ...
    MatricePipeline( glm::mat4 m )
    { matr_.push( m ); }

    operator glm::mat4() const { return matr_.top(); }
    operator const GLfloat*() const { return glm::value_ptr(matr_.top()); }

    MatricePipeline operator*( MatricePipeline matr ) { MatricePipeline resul( getMatr() * matr.getMatr() ); return resul; }
